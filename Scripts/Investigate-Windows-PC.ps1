...
Write-Host "3. Active Directory Users:"
Try {
    Get-ADUser -Filter *
}
Catch {
...
Write-Host "5. Local Users Detailed Information:"
...
Write-Host "6. Enabled Scheduled Tasks:"
...
Write-Host "7. Recently Modified Files (Top 100):"
...
Write-Host "12. Enabled and Running Scheduled Tasks:"
...
Write-Host "13. Auto-Start Programs (HKLM):"
...
Write-Host "17. Network Interfaces:"
