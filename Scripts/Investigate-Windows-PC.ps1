...
# Function to append the command and its output to the file
...
Append-Output "1. Established Network Connections:" {
...
# 2. Local Users
Append-Output "2. Local Users:" {
    Get-LocalUser
}

# 3. Active Directory Users
Append-Output "3. Active Directory Users:" {
    Try {
        Get-ADUser -Filter *
    }
    Catch {
...
Append-Output "6. Enabled Scheduled Tasks:" {
...
Append-Output "7. Recently Modified Files (Top 100):" {
...
Append-Output "12. Enabled and Running Scheduled Tasks:" {
...
Append-Output "13. Auto-Start Programs (HKLM):" {
...
Append-Output "17. Network Interfaces:" {
