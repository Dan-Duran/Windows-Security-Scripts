...
Write-Host "2. Active Sessions on Shared Drives:"
...
Write-Host "3. Open Files on Shared Drives:" 
...
Write-Host "4. Security Event Logs for Failed Share Access (Event ID 5140):"
